...
namespace ProophTest\Link\FileConnector\Service;
...
use ProophTest\Link\FileConnector\DataType\TestUser;
use ProophTest\Link\FileConnector\DataType\TestUserCollection;
use ProophTest\Link\FileConnector\Mock\StupidWorkflowProcessorMock;
...
final class FileGatewayTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->fileGateway = new FileGateway(
            Bootstrap::getServiceManager()->get('prooph.link.fileconnector.file_type_adapter_manager'),
            Bootstrap::getServiceManager()->get('prooph.link.fileconnector.filename_renderer'),
            $locationTranslator
        );
